...
// CiliumHelm runs the helm command with the given options.
func (kub *Kubectl) CiliumHelm(action, repo, helmName, version, namespace string, options map[string]string) *CmdRes {
	optionsString := ""
...
// HelmRepoInstall installs the repository that contain Cilium helm charts.
func (kub *Kubectl) HelmRepoInstall() *CmdRes {
